...
//    @Transactional
    ...
    public void testRemoveAll(){
        ...
        // Reply -> Board로 연결되어 있으므로(@ManyToOne이므로 단방향 연결)
        // 직접 지워야한다.
        replyRepository.deleteByBoard_Bno(bno);

        // Board <-> BoardImage 양방향 연결(@OneToMany)
        // 아래 설정에 의해서 board의 row를 지우면
        // 참조하는 자식 boardImage의 row로 삭제된다.
    ...
    public void testSearchImageReplyCount(){
        ...
        // boardRepository가 boardsearch를 상속받고 있으므로 해당 메서드에 접근 가능
